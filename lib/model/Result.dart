...
class Result{
  ...
  factory Result.fromJson(Map<String, dynamic> dataJson){
    return Result(id: dataJson['id'], name: dataJson['name'], description: dataJson['description'], cook_time_minutes: dataJson['cook_time_minutes'], thumbnail_url: dataJson['thumbnail_url'], user_ratings: dataJson['user_ratings'], sections: dataJson['sections'], instructions: dataJson['instructions']);
  }
}